...
<body>
	...
	<div class="pre-loader">
		<div class="pre-loader-box">
			<div class="loader-logo"><img src="{{ asset('admin/images/deskapp-logo.svg') }}" alt=""></div>
	...
	<div class="header">
		...
		<div class="header-right">
					...
					<div class="dropdown-menu dropdown-menu-right">
						<div class="notification-list mx-h-350 customscroll">
							<ul>
								...
								<li>
									<a href="#">
										<img src="{{ asset('admin/') }}/images/photo1.jpg" alt="">
										<h3>Lea R. Frith</h3>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed...</p>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="{{ asset('admin/') }}/images/photo2.jpg" alt="">
								...
								<li>
									<a href="#">
										<img src="{{ asset('admin/') }}/images/photo3.jpg" alt="">
										<h3>John Doe</h3>
										<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed...</p>
									</a>
								</li>
								<li>
									<a href="#">
										<img src="{{ asset('admin/') }}/images/photo4.jpg" alt="">
			...
			<div class="github-link">
				<a href="https://github.com/dropways/deskapp" target="_blank"><img src="{{ asset('admin/') }}/images/github.svg" alt=""></a>
			</div>
		</div>
	</div>
		...
		<div class="pd-ltr-20">
			<div class="card-box pd-20 height-100-p mb-30">
				<div class="row align-items-center">
					<div class="col-md-4">
						<img src="{{ asset('admin/images/banner-img.png') }}" alt="">
					</div>
					<div class="col-md-8">
			...
			<div class="card-box mb-30">
				...
				<table class="data-table table nowrap">
					...
					<tbody>
						<tr>
							<td class="table-plus">
								<img src="{{ asset('admin/') }}/images/product-1.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="{{ asset('admin/') }}/images/product-2.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="{{ asset('admin/') }}/images/product-3.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="{{ asset('admin/') }}/images/product-4.jpg" width="70" height="70" alt="">
							</td>
							<td>
						...
						<tr>
							<td class="table-plus">
								<img src="{{ asset('admin/') }}/images/product-5.jpg" width="70" height="70" alt="">
							</td>
							<td>
	...
	<script src="{{ asset('admin/scripts/dashboard.js') }}"></script>
</body>
</html>